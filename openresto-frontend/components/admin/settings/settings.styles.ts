...
export const styles = StyleSheet.create({
  ...
  editorSectionTitle: { ...TYPOGRAPHY.bodyBold },
  editorSectionSub: { ...TYPOGRAPHY.label, marginTop: -6 },
  ...
  editableValue: { ...TYPOGRAPHY.bodyBold, flex: 1 },
  editableInput: { flex: 1 },
  rowActions: { flexDirection: "row", gap: SPACING.sm, alignItems: "center" },
  smallBtn: { ...BUTTON_SIZES.secondary, borderRadius: BORDER_RADIUS.md },
  smallBtnText: { ...TYPOGRAPHY.label },
  ...
  tableList: { paddingLeft: SPACING.xs, paddingTop: SPACING.xs },
  emptyNote: { ...TYPOGRAPHY.label, fontStyle: "italic", paddingVertical: SPACING.sm },
  tableItemRow: {
    flexDirection: "row",
    alignItems: "center",
