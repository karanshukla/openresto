...
export interface paths {
    ...
    "/api/brand/app-icon-ios.png": {
         ...
         *     `pwa-icon-1024.png`: the PWA shape carries the transparency App Store Connect rejects.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/api/brand/app-icon-android-foreground.png": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** The foreground layer of the Android adaptive icon; the background layer is the brand colour from `GET api/brand`. */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/restaurants/{restaurantId}/waitlist": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: {
            ...
            requestBody: {
                content: {
                    ...
                    "text/json": components["schemas"]["JoinWaitlistRequest"];
                    "application/*+json": components["schemas"]["JoinWaitlistRequest"];
                };
            };
            responses: {
    ...
    "/api/admin/waitlist/{id}/seat": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["SeatWaitlistEntryRequest"];
                    "text/json": components["schemas"]["SeatWaitlistEntryRequest"];
                    "application/*+json": components["schemas"]["SeatWaitlistEntryRequest"];
                };
            };
            responses: {
...
export interface components {
    schemas: {
        ...
        /** @description Seats a party. With neither id set the smallest free unit that fits is chosen. */
        SeatWaitlistEntryRequest: {
            /** Format: int32 */
            tableId?: null | number | string;
            /** Format: int32 */
            tableGroupId?: null | number | string;
