...

{
  ...
  echo "INSERT INTO Restaurants(Id,Name,Address,OpenTime,CloseTime,OpenDays,Timezone,BookingsPausedUntil,Tags,ImageUrl,IsArchived,DefaultBookingDurationMinutes,BookingSlotIntervalMinutes,WalkInOnly,WalkInDays,Description,MenuUrl,PhoneNumber,EmailAddress) VALUES(1,'Paddy''s Pub','346 W Girard Ave, Philadelphia, PA','09:00','23:45','1,2,3,4,5,6','America/Toronto',NULL,'mac and cheese,fight milk','/media/location-1.jpg',0,60,30,0,NULL,'Philadelphia''s worst bar, now taking bookings. See our [menu](https://paddyspub.example/menu) — cash only.','https://paddyspub.example/menu','+1 215 555 0123','philly@paddyspub.example');"
  echo "INSERT INTO Restaurants(Id,Name,Address,OpenTime,CloseTime,OpenDays,Timezone,BookingsPausedUntil,Tags,ImageUrl,IsArchived,DefaultBookingDurationMinutes,BookingSlotIntervalMinutes,WalkInOnly,WalkInDays,Description,MenuUrl,PhoneNumber,EmailAddress) VALUES(2,'Paddy''s Pub Toronto','The Alley Behind the Alley, Toronto, ON','09:00','23:45','3,4,5,6','America/Toronto',NULL,'charlie work,mantis toboggan','/media/location-2.webp',0,60,30,0,NULL,'The Alley Behind the Alley. Walk-ins welcome, online bookings for the brave.',NULL,NULL,NULL);"
  echo "INSERT INTO Restaurants(Id,Name,Address,OpenTime,CloseTime,OpenDays,Timezone,BookingsPausedUntil,Tags,ImageUrl,IsArchived,DefaultBookingDurationMinutes,BookingSlotIntervalMinutes,WalkInOnly,WalkInDays,Description,MenuUrl,PhoneNumber,EmailAddress) VALUES(3,'Paddy''s Pub (Vancouver)','Multiple Areas, please don''t ask','00:00','23:00','1,2,3,4,5,6,7','America/Los_Angeles',NULL,'wolf cola,dennis system','/media/location-3.jpg',0,60,30,0,NULL,'Open 24 hours because we lost the keys to the lock. [Reviews](https://paddyspub.example/reviews).','https://paddyspub.example/vancouver-menu.pdf','+1 604 555 0177',NULL);"
