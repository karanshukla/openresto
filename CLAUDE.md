...
- **Not built yet, and separable:** guest push (a subscription table keyed to a booking ref, reminder scheduler, consent, GDPR purge alongside `PurgeBookingAsync`), Wallet passes, and the iOS 4.2 submission probe. Those are what make an App Store submission approvable; Android needs none of them.
